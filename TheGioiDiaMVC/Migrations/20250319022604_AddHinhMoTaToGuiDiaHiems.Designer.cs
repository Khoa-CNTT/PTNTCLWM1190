...
namespace TheGioiDiaMVC.Migrations
{
    ...
    [Migration("20250319022604_AddHinhMoTaToGuiDiaHiems")]
    partial class AddHinhMoTaToGuiDiaHiems
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TheGioiDiaMVC.Data.BanBe", b =>
                {
                    b.Property<int>("MaBb")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("TheGioiDiaMVC.Data.ChiTietHd", b =>
                {
                    b.Property<int>("MaCt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("TheGioiDiaMVC.Data.ChuDe", b =>
                {
                    b.Property<int>("MaCd")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("TheGioiDiaMVC.Data.GopY", b =>
                {
            ...
            modelBuilder.Entity("TheGioiDiaMVC.Data.GuiDiaHiem", b =>
                {
                    b.Property<int>("MaGuiDia")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("MaGuiDia"));
                    ...
                    b.ToTable("GuiDiaHiems");
                });

            modelBuilder.Entity("TheGioiDiaMVC.Data.HangHoa", b =>
                {
                    b.Property<int>("MaHh")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("TheGioiDiaMVC.Data.HoaDon", b =>
                {
                    b.Property<int>("MaHd")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("TheGioiDiaMVC.Data.Loai", b =>
                {
                    b.Property<int>("MaLoai")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TheGioiDiaMVC.Data.NhaCungCap", b =>
                {
                    b.Property<string>("MaNcc")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)")
            ...
            modelBuilder.Entity("TheGioiDiaMVC.Data.PhanQuyen", b =>
                {
                    b.Property<int>("MaPq")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("TheGioiDiaMVC.Data.TrangThai", b =>
                {
                    b.Property<int>("MaTrangThai")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TheGioiDiaMVC.Data.TrangWeb", b =>
                {
                    b.Property<int>("MaTrang")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TheGioiDiaMVC.Data.VChiTietHoaDon", b =>
                {
                    b.Property<double>("DonGia")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("TheGioiDiaMVC.Data.YeuThich", b =>
                {
                    b.Property<int>("MaYt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("TheGioiDiaMVC.Data.BanBe", b =>
                {
                    b.HasOne("TheGioiDiaMVC.Data.HangHoa", "MaHhNavigation")
                        .WithMany("BanBes")
                        .HasForeignKey("MaHh")
                    ...
                    b.HasOne("TheGioiDiaMVC.Data.KhachHang", "MaKhNavigation")
                        .WithMany("BanBes")
                        .HasForeignKey("MaKh")
            ...
            modelBuilder.Entity("TheGioiDiaMVC.Data.ChiTietHd", b =>
                {
                    b.HasOne("TheGioiDiaMVC.Data.HoaDon", "MaHdNavigation")
                        .WithMany("ChiTietHds")
                        .HasForeignKey("MaHd")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("TheGioiDiaMVC.Data.GopY", b =>
                {
                    b.HasOne("TheGioiDiaMVC.Data.ChuDe", "MaCdNavigation")
                        .WithMany("Gopies")
                        .HasForeignKey("MaCd")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("TheGioiDiaMVC.Data.GuiDiaHiem", b =>
                {
                    b.HasOne("TheGioiDiaMVC.Data.KhachHang", "KhachHang")
                        .WithMany()
                        .HasForeignKey("MaKH")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("TheGioiDiaMVC.Data.HangHoa", b =>
                {
                    b.HasOne("TheGioiDiaMVC.Data.Loai", "MaLoaiNavigation")
                        .WithMany("HangHoas")
                    ...
                    b.HasOne("TheGioiDiaMVC.Data.NhaCungCap", "MaNccNavigation")
                        .WithMany("HangHoas")
                        .HasForeignKey("MaNcc")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("TheGioiDiaMVC.Data.HoaDon", b =>
                {
                    ...
                    b.HasOne("TheGioiDiaMVC.Data.TrangThai", "MaTrangThaiNavigation")
                        .WithMany("HoaDons")
            ...
            modelBuilder.Entity("TheGioiDiaMVC.Data.PhanCong", b =>
                {
                    ...
                    b.HasOne("TheGioiDiaMVC.Data.PhongBan", "MaPbNavigation")
                        .WithMany("PhanCongs")
                        .HasForeignKey("MaPb")
                        .IsRequired()
            ...
            modelBuilder.Entity("TheGioiDiaMVC.Data.PhanQuyen", b =>
                {
                    ...
                    b.HasOne("TheGioiDiaMVC.Data.TrangWeb", "MaTrangNavigation")
                        .WithMany("PhanQuyens")

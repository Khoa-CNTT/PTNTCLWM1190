...
namespace TheGioiDiaMVC.Migrations
{
    ...
    [Migration("20250403064230_AddTinNhanTable")]
    partial class AddTinNhanTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TheGioiDiaMVC.Data.TinNhan", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TheGioiDiaMVC.Data.TinNhan", b =>
                {
                    b.HasOne("TheGioiDiaMVC.Data.KhachHang", "NguoiGui")
                        .WithMany()
                        .HasForeignKey("NguoiGuiId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TheGioiDiaMVC.Data.KhachHang", "NguoiNhan")
                        .WithMany()
